...
const Card = ({ title, imgSrc, to, external }: CardProps) => {
  let content = (
    <>
      <img
        className="object-fill object-center h-auto min-h-96 bg-black w-full z-10 opacity-50"
        src={imgSrc}
        alt={title}
      />
  ...
  return (
    <div className="my-1 mx-auto px-1 w-full md:w-1/2 lg:my-4 lg:px-4 lg:w-1/2">
